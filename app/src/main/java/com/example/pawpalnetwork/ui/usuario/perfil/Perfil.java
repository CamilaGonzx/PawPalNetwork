...
import com.example.pawpalnetwork.ui.proveedor.ui.perfil.EditCuentaProveedorActivity;
...
public class Perfil extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextInputEditText editextNombre,  editextEmail, editTextCurrentPasswrd, editTextNewPass , editTextConfPass, tfEditProvEstado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_profile = findViewById(R.id.ivEditProfile_user);
        ...
        if (firebaseUser != null) {
            ...
            db.collection("usuarios")
                    ...
                    .addOnFailureListener(e -> {
                        // Manejo de errores
                        Toast.makeText(Perfil.this, "Error al obtener datos: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    });
        }
    ...
    {
        if (v.getId() == R.id.ivEditProfile_user)
        {
        ...
        {
            Intent intent = new Intent(Perfil.this, EditCuentaProveedorActivity.class);
            startActivity(intent);
            finish();
        }else if (v.getId() == R.id.llEditContrasenia)
        {
            ...
            btn_cambiar_Password.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (firebaseUser != null) {
                        // Verificar si la contraseña actual es correcta (esto debe hacerse con reautenticación)
                        String currentPassword = editTextCurrentPasswrd.getText().toString();

                        // Aquí debes realizar un proceso de reautenticación con la contraseña actual
                        ...
                        firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    // La contraseña actual es correcta, ahora verificamos las nuevas contraseñas
                                    if (editTextNewPass.getText().toString().equals(editTextConfPass.getText().toString())) {
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(Perfil.this, "Contraseña cambiada correctamente", Toast.LENGTH_SHORT).show();
                                                        } else {
                                        ...
                                        Toast.makeText(Perfil.this, "No coinciden las contraseñas", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(Perfil.this, "Contraseña anterior incorrecta", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    } else {
        ...
        {
            Intent intent = new Intent(Perfil.this, ReviewsUsuarioActivity.class);
            startActivity(intent);
            finish();
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Perfil.this, "Verification email sent!", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(Perfil.this, "Error sending verification email", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
    ...
    {
        if (firebaseUser != null) {
            // Si el usuario está autenticado, proceder a eliminarlo
            firebaseUser.delete()
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            g.eliminarUsuario(us.getId(),false);
